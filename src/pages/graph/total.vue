  ...
  <div class="main">
    <div class="main__bar-chart">
      <BarChart
        ...
        :data="graphData.data"
        :background-color="graphData.backgroundColor"
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const barChartColor = {
        base: lighten(themeColor.value, 5),
        active: darken(saturate(themeColor.value, 15), 15),
      };
...
<style lang="scss" scoped>
  ...
  .main {
    &__bar-chart {
      width: 100%;
      height: calc((100vh - 5.6rem) * 0.35);
    }

    &__records {
      overflow-y: auto;
      height: calc((100vh - 5.6rem) * 0.65);
      margin-bottom: -1px;
    }
  }
</style>
